...
public class WidgetViewsFactory extends DataWidgetViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        if (debt.getOwner().hasImage()) {
            ...
            row.setImageViewBitmap(R.id.list_widget_avatar, Resource.roundBitmap(Resource.drawableToBitmap(new AvatarPlaceholderDrawable(ColorPalette.getInstance(this), debt.getOwner().paletteIndex)), 30));
