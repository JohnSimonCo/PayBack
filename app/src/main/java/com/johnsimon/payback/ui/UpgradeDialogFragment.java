...
public class UpgradeDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final ImageView upgradeImage = (ImageView) rootView.findViewById(R.id.upgrade_image);
        upgradeImage.setBackgroundResource(R.anim.lock_open);
        upgradeImage.post(new Runnable() {
            @Override
            public void run() {
                AnimationDrawable frameAnimation = (AnimationDrawable) upgradeImage.getBackground();
