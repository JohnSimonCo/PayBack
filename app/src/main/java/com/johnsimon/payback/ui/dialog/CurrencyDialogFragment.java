...
public class CurrencyDialogFragment extends DataDialogFragment {
				...
				new MaterialDialog.Builder(getActivity())
						...
						.itemsCallback(new MaterialDialog.ListCallback() {
                            ...
                            public void onSelection(MaterialDialog materialDialog, View view, int which, CharSequence charSequence) {
                                try {
                                    selectedCurrency = charSequence.toString();
                                    displayCurrency = charSequence.toString();
                                    updatePreview();
                                } catch (Exception e) {
    ...
    protected void onDataReceived() {
        if (!usingDefaults) {
            ...
            selectedCurrency = userCurrency.id;
            ...
            custom_currency_trailing_zero.setChecked(userCurrency.trailingZeros);
