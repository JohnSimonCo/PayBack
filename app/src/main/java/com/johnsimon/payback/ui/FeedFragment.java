...
public class FeedFragment extends DataFragment implements DebtDetailDialogFragment.Callback {
	...
	public /*static*/ void displayTotalDebt(Resources resources) {
		...
		totalDebtTextView.setText(Debt.totalString(debt, data.preferences, resources.getString(R.string.even), FeedActivity.isAll(), resources.getString(R.string.debt_free)));
	}
