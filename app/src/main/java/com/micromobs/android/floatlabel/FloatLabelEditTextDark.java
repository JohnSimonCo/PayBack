...
@TargetApi(11)
public class FloatLabelEditTextDark
	...
	public FloatLabelEditTextDark(Context context) {
		super(context);
		mContext = context;
		initializeView();
	}

	public FloatLabelEditTextDark(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		mAttrs = attrs;
		initializeView();
	...
	public FloatLabelEditTextDark(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initializeView() {
		...
		mEditTextView.setBackground(getResources().getDrawable(R.drawable.normal_edittext_edit_text_holo_light));
		mEditTextView.setTextColor(getResources().getColor(R.color.gray_text_normal));
