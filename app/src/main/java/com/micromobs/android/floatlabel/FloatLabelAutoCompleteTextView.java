...
public class FloatLabelAutoCompleteTextView
    ...
    private void initializeView() {
        ...
        mInflater.inflate(R.layout.weddingparty_floatlabel_autocompletetextview, this, true);

        mFloatingLabel = (TextView) findViewById(R.id.floating_label_hint_auto);
        mEditTextView = (AutoCompleteTextView) findViewById(R.id.floating_label_edit_text_auto);
